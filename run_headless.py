#!/usr/bin/env python3
"""
ROOP Headless - Versión sin GUI para Google Colab
Versión optimizada que no requiere tkinter/customtkinter
"""
...
# Importar módulos de ROOP (sin UI)
...
def parse_args() -> None:
    ...
    roop.globals.headless = True  # Siempre en modo headless
...
def limit_resources() -> None:
    ...
    if platform.system().lower() == 'windows':
        ...
        kernel32.SetProcessWorkingSetSize(-1, ctypes.c_size_t(8 * 1024 * 1024 * 1024), ctypes.c_size_t(roop.globals.max_memory * 1024 * 1024 * 1024))
    # linux
    if platform.system().lower() == 'linux':
        import resource
        resource.setrlimit(resource.RLIMIT_DATA, (roop.globals.max_memory * 1024 * 1024 * 1024, resource.RLIM_INFINITY))


def pre_check() -> bool:
    if sys.version_info < (3, 9):
        update_status('Python 3.9 or higher is required')
        return False
